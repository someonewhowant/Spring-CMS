            ...
            if (postRepository.count() == 0) {
                ...
                postRepository.save(
                        Post.builder()
                                ...
                                .body(
                                        "Optimizing the critical path in your Spring Boot applications requires a deep understanding of the JVM, garbage collection, and thread pool management. In this post, we explore techniques to squeeze every millisecond of performance.")
                                .category(backend)
                                .imageUrl(
                ...
                postRepository.save(
                        Post.builder()
                                ...
                                .body(
                                        "While microservices offer scalability and independence, they also introduce complexity in data consistency and network reliability. We discuss how to handle distributed transactions and service discovery effectively.")
                ...
                postRepository.save(
                        Post.builder()
                                ...
                                .body(
                                        "Apache Kafka has become the de-facto standard for event-driven architectures. Learn how to design a resilient data pipeline that handles millions of events per second with ease.")
            ...
            if (courseRepository.count() == 0) {
                Course architectureCourse =
                        Course.builder()
                                ...
                                .description(
                                        "A comprehensive guide to designing scalable, reliable, and maintainable systems from scratch.")
                                .content(
                                        "In this course, we cover the fundamental principles of system design, including CAP theorem, Load Balancing, and Database Sharding.")
                                .level("Advanced")
                                .duration("15 Hours")
                                .imageUrl(
                                        "https://images.unsplash.com/photo-1508921334112-4c6ef99ce26d?auto=format&fit=crop&q=80&w=1000")
                                .build();
                ...
                moduleRepository.save(
                        CourseModule.builder()
                                ...
                                .content(
                                        "Horizontal vs Vertical scaling. Sharding mechanisms and rebalancing.")
                                .orderIndex(1)
                                .course(architectureCourse)
                                .build());
                ...
                Course backendCourse =
                        Course.builder()
                                ...
                                .description(
                                        "Master the core concepts of Spring Framework and build enterprise-grade applications.")
                                .content(
                                        "Deep dive into Spring Core, Security, Data, and Cloud. Learn how to build production-ready APIs.")
                                .level("Beginner")
                                .duration("20 Hours")
                                .imageUrl(
