...
public class MainController {
    ...
    public String index(Model model) {
        ...
        List<Course> recentCourses =
                courseService.getAllCourses().stream().limit(3).collect(Collectors.toList());
    ...
    public String articles(@RequestParam(defaultValue = "1") int page, Model model) {
        ...
        return populateModelAndReturn(
                postPage,
                page,
                "Articles",
                "Explore all insights from our blog.",
                model,
                "articles");
    }
    ...
    public String deleteComment(
        ...
        if (!isOwner && !isAdmin) {
            redirectAttributes.addFlashAttribute(
                    "commentError", "You don't have permission to delete this comment.");
    ...
    private void populateModuleStatuses(
            Course course, User user, Model model, Long currentModuleId) {
        ...
        if (user != null) {
            ...
            if (user.getLastOpenedCourseId() != null
                    ...
                    && user.getLastOpenedModuleId() != null) {
    ...
    public String takeQuiz(
            @PathVariable Long id, @RequestParam(required = false) Long moduleId, Model model) {
        ...
        for (Question question : quiz.getQuestions()) {
            ...
            for (QuestionOption option : question.getOptions()) {
                ...
                if (selectedOptionId != null
                        && selectedOptionId.equals(option.getId().toString())) {
