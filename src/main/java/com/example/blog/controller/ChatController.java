...
public class ChatController {
    ...
    public String chatPage(
            @RequestParam(value = "with", required = false) Long withUserId,
        ...
        if (currentUser.getRole() == Role.STUDENT) {
            ...
            List<User> withDialogues =
                    chatService.getConversationsForUser(currentUser).stream()
    ...
    public List<ChatMessageDto> getMessages(
            @PathVariable Long partnerId, Authentication authentication) {
        User currentUser = getCurrentUser(authentication);
    ...
    public ResponseEntity<?> clearHistory(
            @RequestParam Long partnerId, Authentication authentication) {
        User currentUser = getCurrentUser(authentication);
